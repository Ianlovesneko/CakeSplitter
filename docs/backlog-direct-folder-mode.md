...
CakeSplitter v0.2.1 keeps Direct Folder Mode disabled as a fail-closed security
decision. Compatibility downloads remain the only browser output path until a
