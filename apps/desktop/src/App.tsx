  ...
  return (
    <div className={settings.reduceMotion ? 'app app--reduced-motion' : 'app'}>
      ...
      <header className="topbar">
        ...
        <span className="version">v{runtime?.applicationVersion ?? '0.7.0-dev'}</span>
      </header>
  ...
  return (
    <>
      ...
      <div className="about-grid">
        ...
        <section className="panel panel--wide"><h2>Known boundary</h2><p>The v0.7.0-dev development line remains Windows 10 and Windows 11 x64 only. The unsigned installer is a private local preview. Resume is at verified Slice boundaries, not arbitrary bytes.</p></section>
      </div>
    </>
  );
}
