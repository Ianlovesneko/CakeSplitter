  ...
  return (
    <div className={settings.reduceMotion ? 'app app--reduced-motion' : 'app'}>
      ...
      <header className="topbar">
        ...
        <span className="version">v{runtime?.applicationVersion ?? '0.5.0'}</span>
      </header>
  ...
  return (
    <>
      ...
      <div className="about-grid">
        ...
        <section className="panel panel--wide"><h2>Known boundary</h2><p>Windows 10 and Windows 11 x64 only for v0.5.0. Installers are unsigned previews unless a real signing certificate is configured. Resume is at verified Slice boundaries, not arbitrary bytes.</p></section>
      </div>
    </>
  );
}
