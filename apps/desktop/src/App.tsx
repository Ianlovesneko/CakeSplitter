  ...
  return (
    <div className={settings.reduceMotion ? 'app app--reduced-motion' : 'app'}>
      ...
      <header className="topbar">
        ...
        <span className="version">v{runtime?.applicationVersion ?? '0.8.1'}</span>
      </header>
  ...
  return (
    <>
      ...
      <div className="about-grid">
        ...
        <section className="panel panel--wide"><h2>Known boundary</h2><p>The v0.8.1 pre-release remains Windows 10 and Windows 11 x64 only. Windows binaries are unsigned and SmartScreen may warn. Resume is at verified Slice boundaries, not arbitrary bytes.</p></section>
      </div>
    </>
  );
}
